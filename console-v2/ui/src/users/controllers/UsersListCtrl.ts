...
export default class UsersListCtrl {
    ...
    constructor(private $scope: any,
        ...
        var deleteItems = function (action) {
            ...
            if (selectedItems.length) {
                ...
                let modal = $modal.open({
                    template: require("../views/delete-users-modal.html"),
        ...
        var addItem = function (action) {
            let modal = $modal.open({
                template: require("../views/add-user-modal.html"),
        ...
        var viewDetails = function (action, item) {
            $state.go("kapua.users.detail", { id: item.id });
        }
        ...
        $scope.updateItems = function () {
            ...
            $timeout(() => {
                usersService.getUsers().then((result: ng.IHttpPromiseCallbackArg<ListResult<User>>) => {
