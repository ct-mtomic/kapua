...
public class GroupServiceImpl extends AbstractKapuaService implements GroupService {
    ...
    public Group create(GroupCreator groupCreator)
        ...
        authorizationService.checkPermission(permissionFactory.newPermission("group", Actions.write, groupCreator.getScopeId()));
    ...
    public Group update(Group group) throws KapuaException {
        ...
        AuthorizationService authorizationService = locator.getService(AuthorizationService.class);
        PermissionFactory permissionFactory = locator.getFactory(PermissionFactory.class);
        authorizationService.checkPermission(permissionFactory.newPermission("group", Actions.write, group.getScopeId()));
    ...
    public void delete(KapuaId scopeId, KapuaId groupId) throws KapuaException {
        ...
        AuthorizationService authorizationService = locator.getService(AuthorizationService.class);
        PermissionFactory permissionFactory = locator.getFactory(PermissionFactory.class);
        authorizationService.checkPermission(permissionFactory.newPermission("group", Actions.delete, scopeId));
    ...
    public Group find(KapuaId scopeId, KapuaId groupId)
        ...
        AuthorizationService authorizationService = locator.getService(AuthorizationService.class);
        PermissionFactory permissionFactory = locator.getFactory(PermissionFactory.class);
        authorizationService.checkPermission(permissionFactory.newPermission("group", Actions.read, scopeId));
    ...
    public GroupListResult query(KapuaQuery<Group> query)
        ...
        AuthorizationService authorizationService = locator.getService(AuthorizationService.class);
        PermissionFactory permissionFactory = locator.getFactory(PermissionFactory.class);
        authorizationService.checkPermission(permissionFactory.newPermission("group", Actions.read, query.getScopeId()));
