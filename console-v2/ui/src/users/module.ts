...
angular.module("app.users", [])
    ...
    // controllers
    .controller("UsersListCtrl", ["$scope", "$timeout", "$filter", "$uibModal", "$state", "usersService", UsersListCtrl])
    ...
    .controller("UserPermissionsCtrl", ["$stateParams", "$scope", "$timeout", "$filter", "$uibModal", "$state", "usersService", UserPermissionsCtrl])
    .controller("UserRolesCtrl", ["$stateParams", "$scope", "$timeout", "$filter", "$uibModal", "$state", "usersService", UserRolesCtrl]) 
    .controller("UserCredentialsCtrl", ["$stateParams", "$scope", "$timeout", "$filter", "$uibModal", "$state", "usersService", UserCredentialsCtrl])
    .controller("AddUserRoleModalCtrl", ["$uibModalInstance", "userID", "refreshRoleList", "usersService", AddRoleModalCtrl])
    .controller("DeleteUserRolesModalCtrl", ["$uibModalInstance", "usersService", "userID", "ids",  "refreshRoleList", DeleteRolesModalCtrl])
    .controller("GrantUserPermissionModalCtrl", ["$uibModalInstance", "userID", "refreshPermissionsList", "usersService", GrantPermissionModalCtrl])
    .controller("RevokeUserPermissionsModalCtrl", ["$uibModalInstance", "usersService", "userID", "ids",  "refreshPermissionsList", RevokePermissionsModalCtrl])
    .controller("AddUserCredentialModalCtrl", ["$uibModalInstance", "editUserID", "editCredentialID", "refreshCredentialList",  "usersService", AddCredentialModalCtrl])
    .controller("DeleteUserCredentialsModalCtrl", ["$uibModalInstance", "usersService", "userID", "ids",  "refreshCredentialList", DeleteCredentialsModalCtrl]);