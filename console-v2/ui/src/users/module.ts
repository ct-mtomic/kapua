...
angular.module("app.users", [])
    ...
    // controllers
    .controller("UsersListCtrl", ["$scope", "$timeout", "$modal", "$state", "usersService", UsersListCtrl])
    ...
    .controller("UserPermissionsCtrl", ["$stateParams", "$scope", "$timeout", "$modal", "$state", "usersService", UserPermissionsCtrl])
    .controller("UserRolesCtrl", ["$stateParams", "$scope", "$timeout", "$modal", "$state", "usersService", UserRolesCtrl]) 
    .controller("UserCredentialsCtrl", ["$stateParams", "$scope", "$timeout", "$modal", "$state", "usersService", UserCredentialsCtrl])
