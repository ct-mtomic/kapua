...
export default class AddUserModalCtrl {
    ...
    getUserById(userID: string): void {
        this.childAccountsService.getUserById(userID).then((responseData: ng.IHttpPromiseCallbackArg<User>) => {
    ...
    addUser() {
        this.childAccountsService.addUser(this.submitModel).then((responseData: ng.IHttpPromiseCallbackArg<User>) => {
    ...
    editUser(userID: string) {
        ...
        this.childAccountsService.updateUser(userID, updateModel).then((responseData: ng.IHttpPromiseCallbackArg<User>) => {
